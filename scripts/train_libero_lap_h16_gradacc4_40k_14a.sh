...
TASK="${TASK:-libero_raw_osc_h16_a14}"
CONFIG_FILE="${CONFIG_FILE:-configs/libero_raw_osc_lap_h16_gradacc4_40k_a14.yaml}"
RUN_NAME="${RUN_NAME:-${TASK}_lap_after_pretrain_gradacc4_step40000}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/motus-${TASK}/${RUN_NAME}}"
LOG_FILE="${LOG_FILE:-${OUTPUT_DIR}/train_a14.log}"
