...
# HyperTrain/Kubernetes launcher for RobotWin LAP finetuning with grad accumulation.
...
TASK="${TASK:-robotwin_lap_grad4}"
CONFIG_FILE="${CONFIG_FILE:-configs/robotwin_lap_grad4.yaml}"
...
echo "=========================================="
echo "HyperTrain RobotWin LAP Grad4 Finetune"
echo "Time: $(date)"
