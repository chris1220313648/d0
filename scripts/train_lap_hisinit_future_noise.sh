#!/bin/bash
#SBATCH --job-name=motus_lap_hisinit_future_noise
...
CONFIG_FILE="configs/robotwin_lap_future_noise.yaml"  # Define your dataset config path here
...
torchrun \
    ...
    --config $CONFIG_FILE \
    --run_name ${TASK}_lap_future_video_noise \
    --report_to tensorboard \
    > $OUTPUT_DIR/train_lap_hisinit_future_noise.log 2>&1
