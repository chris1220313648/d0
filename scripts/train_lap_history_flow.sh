#!/bin/bash
# Train RoboTwin LAP with current-frame/history-qpos flow sources.
...
TASK="robotwin_history_flow"
CONFIG_FILE="configs/robotwin_lap_history_flow.yaml"
...
torchrun \
    ...
    --config $CONFIG_FILE \
    --run_name ${TASK}_lap_history_flow \
    --report_to tensorboard \
    > $OUTPUT_DIR/train_lap_history_flow.log 2>&1
