...
# HyperTrain/Kubernetes launcher for LAP multi-dataset v4 training.
...
TASK="${TASK:-multidataset_lap_v4}"
CONFIG_FILE="${CONFIG_FILE:-configs/multidataset_lap_v4.yaml}"
...
echo "=========================================="
echo "HyperTrain LAP Multi-Dataset v4"
echo "Time: $(date)"
