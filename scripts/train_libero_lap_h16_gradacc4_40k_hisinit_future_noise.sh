...
TASK="${TASK:-libero_raw_osc_h16_hisinit_future_noise}"
CONFIG_FILE="${CONFIG_FILE:-configs/libero_raw_osc_lap_h16_gradacc4_40k_hisinit_future_noise.yaml}"
RUN_NAME="${RUN_NAME:-${TASK}_lap_after_pretrain_gradacc4_step40000}"
...
echo "Starting LIBERO H16-E8 history-init + future-noise training:"
