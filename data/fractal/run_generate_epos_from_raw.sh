#!/bin/bash
# One-click runner for Fractal epos generation from original RLDS action.

set -u

echo "Starting Fractal epos generation at $(date)"

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PY_SCRIPT="${SCRIPT_DIR}/fractal_generate_epos_from_raw.py"
...
LOG_FILE="${LOG_DIR}/fractal_epos_from_raw_${TIMESTAMP}.log"
