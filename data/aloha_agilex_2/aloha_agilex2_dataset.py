# Aloha-Agilex2 Dataset Loader for Motus
# Supports Aloha-Agilex2 robot data with video and action data from multiple tasks
...
class AlohaAgilex2Dataset(data.Dataset):
    """
    Dataset for Aloha-Agilex2 data with task-level organization.
    Updated for three-modal UniDiffuser (WAN + Action Expert + VLM).
    
    Data structure:
    /share/dataset/preprocess/aloha_agilex_2/
    ├── task_category_1/
    │   ├── task_variant_1.json
    │   ├── task_variant_1/
    │   │   ├── videos/
    ...
    def __init__(
        self,
        dataset_dir: str = "/share/home/bhz/test/latent_action_world_model/lawm/data/aloha_agilex_2",
        ...
        **kwargs
        ...
        self.action_min, self.action_max = load_normalization_stats(str(stat_path), 'aloha_agilex_2')
        ...
        logger.info(f"Aloha-Agilex2 Dataset initialized with {len(self.episodes)} episodes")
    ...
    def __len__(self):
        ...
        return len(self.episodes) * 10000  # Align with AC-One dataset length estimation
