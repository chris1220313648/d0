...
# -*- coding: utf-8 -*-
"""
Generate Bridge `epos/*.pt` from original RLDS actions only.
...
# Reuse Bridge converter helpers so grouping/slugging stays fully consistent.
try:
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Generate bridge epos from RLDS action.",
    )
...
def main() -> int:
    ...
    logger.info("Bridge epos generation-from-raw config:")
